...
{      !insideCategory &&   <button onClick={()=>deleteVideo(displayData?.id)} className='btn'> <i className=' fa-solid fa-trash  text-danger'></i></button>
    ...
    <Modal size='lg' show={show} onHide={handleClose} centered>
        ...
        <Modal.Body>
        <iframe width="100%" height="360" src={`${displayData?.link}?autoplay=1`} title="Coldplay Toronto 2006 Full Concert HD"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
